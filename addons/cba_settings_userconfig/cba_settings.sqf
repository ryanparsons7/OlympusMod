...
Achilles_var_R3F = true;
Achilles_var_R3F_MIS = true;
...
Achilles_var_sfp_criminals = true;
Achilles_var_sfp_police = true;
Achilles_var_sfp_swe_1981 = true;
Achilles_var_sfp_swe_1990 = true;
Achilles_var_sfp_swe_1990s = true;
Achilles_var_sfp_swe_2015 = true;
Achilles_var_sfp_swe_2015d = true;
Achilles_var_sfp_swe_2035 = true;
Achilles_var_sfp_un = true;
Achilles_var_sfp_un_congo = true;
